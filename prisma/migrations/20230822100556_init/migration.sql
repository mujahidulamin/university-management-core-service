...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicSemisterId_fkey" FOREIGN KEY ("academicSemisterId") REFERENCES "academic_semesters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
